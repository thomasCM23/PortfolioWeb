...
class InMemoryDataService extends MockClient {
  static final _initialProjects = [
    ...
    {'id': 2, 'title': 'Human Protein Image Classification', 'description': 'Develop models capable of classifying mixed patterns of proteins in microscope images', 'url': '', 'imagePath': 'ProjectDiscoveryProtein.jpg', 'tech': 'Python, Tensorflow'},
    {'id': 2, 'title': 'Neural Style Transfer', 'description': 'Transform the content images to the style of another image, using convolutional neural nets.', 'url': '#/neuralStyle', 'imagePath': 'card_neuraltransfer.png', 'tech': 'Python, Tensorflow, Keras'},
    {'id': 2, 'title': 'Eng to Fre ML App (Future)', 'description': 'Using deep recurrent neural network for machine transalation from engilish to french.', 'url': '', 'imagePath': 'flutter.png', 'tech': 'Python, Tensorflow, Flutter'},
